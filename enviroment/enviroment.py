...
class GraphicDisplay(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        iteration_button.configure(width=10,activebackground="#33B5#5")
        canvas.create_window(WIDTH*UNIT*0.13,HEIGHT*UNIT+10,window=iteration_button)
        
        policy_button=Button(self,text="Improve",commans=self.improve_policy)
        ...
        self.retangle=canvas.create_image(50,50,image=self.shapes[0])
    ...
    def reset(self):
        if self.is_moving==0:
            ...
            x,y=self.canvas.coords(self.retangle)
            self.canvas.move(self.retangle,UNIT/2-x,UNIT/2-y)
